package com.anvarzhonzhurajev.taskmanager
...
fun main(args: Array<String>) {
    ...
    listOf(TaskManager(capacity), QueuedTaskManager(capacity), PriorityTaskManager(capacity)).forEach {
        ...
        // Demo for adding processes after capacity has been reached
        ...
        // Demo for adding another task (behaves differently for different classes)
